...
function findWasmBinary() {
  if (Module["locateFile"]) {
    var f = "boost-cpp-emscripten.wasm";
    if (!isDataURI(f)) {
      return locateFile(f);
    }
    return f;
  ...
  return new URL("boost-cpp-emscripten.wasm", import.meta.url).href;
}
...
export default PolyuworldEmscriptenAddonTemplate;
